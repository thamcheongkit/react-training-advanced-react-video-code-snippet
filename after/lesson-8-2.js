...
class App extends Component {
    ...
    render() {
        ...
        return (
            <div id="app" className={`App ${color}-blue-bg`}>
                <Tabs defaultActiveIndex={2}>
                    <TabList>
                        <Tab><FaAutomobile className={currnetTab === 0 ? COLORS[currentTab] : ''}/></Tab>
                        <Tab><FaBed className={currnetTab === 1 ? COLORS[currentTab] : ''}/></Tab>
                        <Tab><FaPlane className={currnetTab === 2 ? COLORS[currentTab] : ''}/></Tab>
                        <Tab><FaSpaceShuttle className={currnetTab === 3 ? COLORS[currentTab] : ''}/></Tab>
                    </TabList>
                    <TabPanels>
